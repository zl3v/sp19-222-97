...
//ADDED: 4/2/19
void write_score(blocks_game *game)
{
  ofstream myfile;
  myfile.open("current_score.txt");
  myfile << game -> score();
  myfile.close();
}

//ADDED: 4/2/19
void write_level(blocks_game *game)
{
  ofstream myfile;
  myfile.open("current_level.txt");
  myfile << game -> level();
  myfile.close();
}
...
//{
  //ofstream myfile;
  //myfile.open("current_times.txt");
  //myfile << seconds_since_start;
  //myfile.close();
//}
